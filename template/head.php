...
<img src="/image/icon/menu.png" onClick="Head.show();" style="position: relative;
  ...
  <div class="head-left" style="width:190px;margin-left:14px;">
...
<div id="lol" style="display:none;position: absolute;top:54px;z-index:9999;margin-left:124px;background-color:#FFF;width:210px;border:1px solid #DDD;padding:7px 0;"></div>
...
<div style="position:fixed;top:0;left:0;right:0;bottom:0;display: none;" id="lol2xp" onClick="document.getElementById('lol').style.display='none';this.style.display='none';"></div>
  ...
  <div style="text-align: center;width:143px;margin:auto;">
    <a href="//www.digitalwind.ru" target="_blank">
    <img id="bxid_862078" src="http://www.digitalwind.ru/upload/2021/лого2021.png" title="www.digitalwind.ru" border="0" align="left" alt="www.digitalwind.ru" width="143" height="51" />
</a>
...
if(!empty($_SESSION['user_id'])) {
  ...
  echo '<div style="margin: 14px 0 7px 0;padding-bottom:14px;border-bottom:1px solid #ddd">
        ...
        ?>
        <a class="sidebar-content__line_wrap" href="/index.php"><div class="sidebar-content__line">Все категории</div></a>
        <a class="sidebar-content__line_wrap" href="/index.php?category_id=1"><div class="sidebar-content__line">Десерты</div></a>
        <a class="sidebar-content__line_wrap" href="/index.php?category_id=2"><div class="sidebar-content__line">Основые блюда</div></a>
        <a class="sidebar-content__line_wrap" href="/index.php?category_id=3"><div class="sidebar-content__line">Салаты</div></a>
        <a class="sidebar-content__line_wrap" href="/index.php?category_id=4"><div class="sidebar-content__line">Коктейли</div></a>
        <a class="sidebar-content__line_wrap" href="/index.php?category_id=5"><div class="sidebar-content__line">Супы</div></a>
        <a class="sidebar-content__line_wrap" href="/index.php?category_id=6"><div class="sidebar-content__line">Сэндвичи</div></a>

        <a class="sidebar-content__line_wrap" href="/index.php?category_id=7"><div class="sidebar-content__line">Пицца</div></a>
